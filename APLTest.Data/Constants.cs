namespace APLTest.Data
{
    ...
    {
        public static string No_File_Found = "The file you've uploaded doesnt exist or has no data";
        public static string File_Uploaded_Successful = "File uploaded successfully";
